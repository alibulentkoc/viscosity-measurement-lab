...
\section{Safety}
\begin{itemize}
  \item Fluids heated to 50--60\,\textdegree C will burn skin. Use gloves and tongs on the
...
valid ($\mathit{Re}<1$) \quad$\cdot$\quad marginal (1--10) \quad$\cdot$\quad
...
A rotary viscometer measures the absolute viscosity of a fluid directly. A rotor immersed in the
